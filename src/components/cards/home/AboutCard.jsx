  ...
  return (
    <div className="group flex flex-col items-start justify-between w-full h-full gap-4">
      <div className="flex flex-col items-start justify-center w-full gap-2">
        <div className="flex items-center justify-between w-full">
          <h3 className="text-2xl">
            Hi, I'm{" "}
            <span className="text-primary font-secondary font-medium ">{admin.name}</span>{" "}
          </h3>
          <Link
            to={"/about"}
            type="button"
            className="border border-border rounded-full group-hover:rotate-45 bg-dark group-hover:bg-primary group-hover:text-dark transition-all duration-300 ease-in-out  p-1.5"
          >
        ...
        <p className="text-xl">
          I am a{" "}
          <span className="text-primary font-secondary font-medium">Computer Engineer</span>{" "}
      ...
      <div className="flex items-center gap-4 self-end m-4">
        ...
        >
          <IconFileText size={32} strokeWidth={1.5} />
        </button>
        <a
          href={linkedIn?.url}
          target="_blank"
          ...
          className="text-primary rounded-full   active:translate-y-0.75 cursor-pointer transition-all duration-300"
        >
          <IconBrandLinkedin size={32} strokeWidth={1.5} />
        </a>
        <a
          href={github?.url}
          target="_blank"
